...
<div class="alert alert-info tw-mt-4 tw-mb-4">
    <strong>✅ CRON JOB CONFIGURATION</strong><br><br>

    <p><strong>Main System Cron:</strong><br>
        <code>wget -q -O - https://citrus.mu/cron</code>
    </p>

    <p><strong>Tenant Cron (jf210):</strong><br>
        <code>curl -s https://citrus.mu/jf210/ps/cron</code>
    </p>
</div>
</script>