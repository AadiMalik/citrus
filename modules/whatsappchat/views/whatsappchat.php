                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="bold" for="whatsappchat_clients_and_admin_area">Mobile phone for both Admin & Clients area chat: <i class="fa fa-question-circle" data-toggle="tooltip" data-title="Enter a mobile phone here if you want WhatsApp Chat to be loaded in both frontend and backend of Perfex CRM. Leave this field blank and chat code will not load in both areas."></i></label>
                            <br><textarea name="whatsappchat_clients_and_admin_area" id="whatsappchat_clients_and_admin_area" class="form-control" rows="1"><?php echo clear_textarea_breaks(get_option('whatsappchat_clients_and_admin_area')); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="bold" for="whatsappchat_admin_area">Mobile phone for Admin area chat: <i class="fa fa-question-circle" data-toggle="tooltip" data-title="Enter a mobile phone here if you want WhatsApp Chat to be loaded the backend of Perfex CRM. Leave this field blank and chat code will not load in the backend."></i></label>
                            <textarea name="whatsappchat_admin_area" id="whatsappchat_admin_area" class="form-control" rows="1"><?php echo clear_textarea_breaks(get_option('whatsappchat_admin_area')); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="bold" for="whatsappchat_clients_area">Mobile phone for Customers area chat: <i class="fa fa-question-circle" data-toggle="tooltip" data-title="Enter a mobile phone here if you want WhatsApp Chat to be loaded the backend of Perfex CRM. Leave this field blank and chat code will not load in the frontend."></i></label>
                            <textarea name="whatsappchat_clients_area" id="whatsappchat_clients_area" class="form-control" rows="1"><?php echo clear_textarea_breaks(get_option('whatsappchat_clients_area')); ?></textarea>
                        </div>
                        <br>
                        <br>
