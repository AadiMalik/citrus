...
$config['log_threshold'] = 4;  // Make sure this is not 0
$config['log_path'] = '';     // Leave blank to use default path
...
$config['csrf_exclude_uris'] = ['admin/customemailandsmsnotifications/email_sms/sendEmailSms', 'forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'api\/.+', 'razorpay/success\/.+'];
