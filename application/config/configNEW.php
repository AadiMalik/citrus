...
define('APP_CRON_KEY', 'idacr0nsecure456');
...
$config['csrf_exclude_uris'] = ['admin/customemailandsmsnotifications/email_sms/sendEmailSms', 'admin/custom_email_and_sms_notifications/email_sms/sendEmailSms', 'forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'api\/.+', 'razorpay/success\/.+'];
