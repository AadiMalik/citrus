...
$info_right_column .= '<?php
$vat_status = get_custom_field_value($invoice->clientid, 'VAT Registered', 'customers');
$invoice_heading = !empty($vat_status) ? 'VAT INVOICE' : 'INVOICE';
?>
<span style="font-weight:bold;font-size:27px;"><?php echo $invoice_heading; ?></span><br />';
