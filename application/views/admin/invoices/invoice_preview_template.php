                ...
                <div class="col-md-9 _buttons">
                    ...
                    <div class="pull-right">
                        ...
                        <?php if (!empty($invoice->clientid)) { ?>
                            ...
                            <?php if (!empty($invoice->clientid)) { ?>
                                <span<?php if ($invoice->status == Invoices_model::STATUS_CANCELLED) { ?> data-toggle="tooltip"
                                    data-title="<?php echo 'WhatsApp sending is disabled for cancelled invoices'; ?>" <?php } ?>>
                                    <a href="#" class="invoice-send-to-whatsapp btn-with-tooltip btn btn-success<?php if ($invoice->status == Invoices_model::STATUS_CANCELLED) {
                                                                                                                    echo ' disabled';
                                                                                                                } ?>" data-toggle="tooltip" title="<?php echo 'Send Invoice via WhatsApp'; ?>" data-invoice-id="<?php echo $invoice->id; ?>" data-placement="bottom">
