            ...
            <div role="tabpanel" class="tab-pane<?php if (!$this->input->get('tab')) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-<?php echo !isset($client) ? 12 : 8; ?>">
                        ...
                        <?php
                        $label  = '<span>' . _l('client_phonenumber') .
                            ' <small>(must add country code for smooth whatsapp messages — e.g., Pakistan: 9230xxxxxxx)</small></span>';

                        $attrs = [
                            'autocomplete' => 'off',
                            'placeholder'  => 'Example: 9230xxxxxxx'
                        ];

                        echo render_input('phonenumber', $label, $value, 'text', $attrs);
                        ?>
